...
1. **Join the Class Workspace**  
   ...
   [Join Class Workspace](https://posit.cloud/spaces/605675/join?access_code=Js3OPYFsmb02-lu9ANwDVyD99JWafdiOTG66yKwE)

2. **Access the RStudio Cloud Project**  
   Once you have joined the workspace, access the RStudio Cloud Project using this link:  
   [Access the Project](https://posit.cloud/spaces/605675/content/9686609)
